<<<<<<< HEAD:src/app/components/Footer.js
          ...
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-600">
               <Image src="/logo.png" alt='footer logo ' width={50} height={30} ></Image>
              </div>
              <span className="self-center md:text-3xl text-xl font-bold  hover:text-purple-600">
               Resume Maker
              </span>
            </a>
          </div>
...
export default Footer;
>>>>>>> 213fb9e617ca3b236e2027356eaa672ca91372e9:src/components/Footer.js
